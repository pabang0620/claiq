...
## 사용자 페인포인트 크롤링 기반 기획 리서치 - 2026-04-07
...
- **gpt-4o-mini 기본값**: gpt-4o 대비 대폭 비용 절감, 수능 문제 생성 품질 충분
...
## 공모전 수상작 분석 및 고득점 전략 수립 - 2026-04-07
...
## Playwright 기반 전 기능 API 통합 테스트 및 버그 수정 - 2026-04-07
