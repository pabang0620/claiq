...
| ③ 수능 유형 매핑 (GPT-4o) | GPT-4o | 입력 2K + 출력 500 tokens | ~$0.010 |
| ④ 문제 생성 3난이도 (GPT-4o) | GPT-4o | 입력 6K + 출력 3K tokens × 3 | ~$0.105 |
| **강의 1편 합계** | | | **~$0.30** |
...
| 기능 | API | 토큰 | 비용 |
|------|-----|------|------|
| AI Q&A 1회 (RAG) | GPT-4o | 입력 2K + 출력 500 tokens | ~$0.010 |
| 미니 모의고사 생성 | GPT-4o | 입력 3K + 출력 2K tokens | ~$0.028 |
| D-day 로드맵 생성 | GPT-4o | 입력 2K + 출력 1K tokens | ~$0.020 |

### 학원 규모별 월 예상 비용

| 학원 규모 | 강의/월 | 수강생 Q&A/일 | 예상 월 AI 비용 |
|----------|---------|-------------|--------------|
| 소규모 (강사 3명, 수강생 50명) | 30편 | 50회 | **~$24** |
| 중규모 (강사 7명, 수강생 150명) | 70편 | 150회 | **~$66** |
...
| LLM | OpenAI GPT-4o | 긴 트랜스크립트 + 수능 문체 생성 |
