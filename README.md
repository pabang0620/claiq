...
| 구분 | 내용 | 예상 단가 |
|------|------|----------|
| **SaaS 기본 구독** | 학원당 월 정액 (강사 수 기준) | 5만원~15만원/월 |
| **AI 사용량 과금** | 기본 할당량 초과 시 (강의 처리·Q&A) | 강의당 200~500원 |
| **리포트 발송 과금** | SMS/알림톡 학부모 발송 (Solapi 연동) | 건당 10~30원 |

**목표 시장**: 전국 사설 학원 약 7만 개 중 수능 전문 학원 약 1.5만 개.
수능 전문 학원의 5%만 도입해도 월 3,750만원 MRR.
